...
export function BandProvider({ initialBand, children }: { initialBand: string; children: React.ReactNode }) {
  ...
  const setBand = useCallback((newBand: string) => {
