    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          ...
          <form action={formAction} className="space-y-5">
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5">
                ...
                <a href="#" className="text-xs font-semibold text-yellow hover:text-yellow-dim transition-colors">
                  Forgot password?
                </a>
              </div>
              <input
          ...
          <button className="w-full border border-grey-light hover:border-navy-light text-navy font-medium py-3 rounded-xl transition-colors text-sm flex items-center justify-center gap-3">
