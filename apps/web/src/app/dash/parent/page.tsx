      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <h2 className="text-xl font-bold text-slate-800 flex items-center gap-2">
            <span>👨‍👩‍👧‍👦</span> Enrolled Children Overview
          </h2>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
              ...
              <div className="p-4 bg-slate-50">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded bg-white shadow-sm border border-slate-200 flex items-center justify-center">📐</div>
                  <div>
          ...
          <Card className="rounded-2xl shadow-sm border-slate-200">
            ...
            <CardContent className="pt-6">
              ...
              <div className="space-y-2">
                <Button variant="outline" className="w-full text-xs h-9 justify-start">📄 Download Recent Invoice</Button>
                <Button variant="outline" className="w-full text-xs h-9 justify-start">💳 Update Payment Method</Button>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6">
              ...
              <ul className="space-y-3">
                <li className="text-sm text-slate-600 hover:text-edvoura-navy cursor-pointer flex items-center gap-2 font-medium">
                  <span className="bg-slate-100 p-1 rounded">📅</span> View Upcoming Schedules
                </li>
                <li className="text-sm text-slate-600 hover:text-edvoura-navy cursor-pointer flex items-center gap-2 font-medium">
                  <span className="bg-slate-100 p-1 rounded">✅</span> Review Assignment Statuses
                </li>
                <li className="text-sm text-slate-600 hover:text-edvoura-navy cursor-pointer flex items-center gap-2 font-medium">
                  <span className="bg-slate-100 p-1 rounded">📚</span> Download Term Reports (PDF)
                </li>
              </ul>
            </CardContent>
          </Card>
