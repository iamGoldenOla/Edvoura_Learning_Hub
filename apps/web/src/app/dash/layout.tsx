        ...
        <nav className="space-y-2 flex-1">
          ...
          {role === 'tutor' && (
            <>
              ...
              <a href="#roster" className="block text-slate-300 hover:text-white py-1">Student Roster</a>
              <a href="#builder" className="block text-slate-300 hover:text-white py-1">Resource & Quiz Builder</a>
              
              <div className="pt-4 mt-4 border-t border-slate-700/50">
                <p className="text-[10px] uppercase tracking-widest text-slate-400 font-bold mb-2">Account</p>
                <a href="#earnings" className="block text-slate-300 hover:text-white py-1">Earnings Dashboard</a>
                <a href="#messages" className="block text-slate-300 hover:text-white py-1">Message Center</a>
              </div>
            </>
          )}
          ...
          {role === 'parent' && (
            <>
              ...
              <a href="#monitor" className="block text-slate-300 hover:text-white py-1">Live Session Monitor</a>
              <a href="#reports" className="block text-slate-300 hover:text-white py-1">Progress Reports</a>
              ...
              <div className="pt-4 mt-4 border-t border-slate-700/50">
                ...
                <a href="#messages" className="block text-slate-300 hover:text-white py-1">Tutor Messages</a>
              </div>
            </>
          )}
          ...
          {role === 'admin' && (
            <>
              <a href="#users" className="block text-slate-300 hover:text-white py-1">User Management</a>
              <a href="#tutors" className="block text-slate-300 hover:text-white py-1">Tutor Approvals</a>
              <a href="#sessions" className="block text-slate-300 hover:text-white py-1">Live Session Control</a>
              
              <div className="pt-4 mt-4 border-t border-slate-700/50">
                <p className="text-[10px] uppercase tracking-widest text-slate-400 font-bold mb-2">Platform</p>
                <a href="#finance" className="block text-slate-300 hover:text-white py-1">Revenue & Payouts</a>
                <a href="#content" className="block text-slate-300 hover:text-white py-1">Content Library</a>
                <a href="#settings" className="block text-slate-300 hover:text-white py-1">System Settings</a>
              </div>
            </>
          )}
