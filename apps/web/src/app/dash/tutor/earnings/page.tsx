            ...
            <div className="space-y-8 xl:col-span-5">
              ...
              <div className="border-[3px] border-dark rounded-3xl bg-blue-100 p-6 shadow-[5px_5px_0px_#060E1C]">
                ...
                <div className="space-y-3">
                  <Link href="/dash/tutor/earnings?action=update-payment" className="flex items-center justify-between rounded-xl border-[2px] border-dark bg-white px-4 py-3 text-sm font-black text-dark hover:bg-yellow hover:translate-x-[2px] hover:translate-y-[2px] shadow-[3px_3px_0px_#060E1C] hover:shadow-none transition-all">
                    <span className="flex items-center gap-2"><PaymentIcon className="h-4 w-4" /> Update Payment Method</span>
