...
export default function TutorLessonNotesPage() {
  ...
  const [selectedGradeFilter, setSelectedGradeFilter] = useState<string>('grade_11');
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b-[3px] border-dark/10 pb-4">
              <div>
                ...
                <h2 className="text-2xl sm:text-3xl font-black text-dark tracking-tight">
                  {selectedGradeFilter === 'grade_11' ? 'SS 2 (Grade 11)' : selectedGradeFilter === 'grade_10' ? 'SS 1 (Grade 10)' : selectedGradeFilter === 'grade_9' ? 'JSS 3 (Grade 9)' : selectedGradeFilter === 'grade_8' ? 'JSS 2 (Grade 8)' : selectedGradeFilter === 'grade_7' ? 'JSS 1 (Grade 7)' : selectedGradeFilter === 'grade_6' ? 'Primary 6 (Grade 6)' : selectedGradeFilter === 'grade_5' ? 'Primary 5 (Grade 5)' : selectedGradeFilter === 'grade_4' ? 'Primary 4 (Grade 4)' : selectedGradeFilter === 'grade_3' ? 'Primary 3 (Grade 3)' : selectedGradeFilter === 'grade_2' ? 'Primary 2 (Grade 2)' : 'Primary 1 (Grade 1)'} Master Lesson Notes
                </h2>
